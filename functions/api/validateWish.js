...
`;
    ...
    // --- 步骤 2: 生成实现场景 ---
    const generationPrompt = `你将会收到用户的愿望。如果愿望是美好的祈愿或朴素善良的人类感情则输出鼓励的话语，尽可能描绘一个美好的场景，使用户的得内心到些许治愈。如果愿望出于用户的贪婪、懒惰、欲望等负面因素，你应该在满足愿望的前提下找到漏洞，使得用户的许愿得不到预期的利益。但如果用户逻辑极其严密，请尽量保证你的输出无争议的满足用户的愿望，即使这样会在最低限度内满足用户的愿望。
